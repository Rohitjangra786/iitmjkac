...
<head>
  ...
  <title>Mad Moments | Management Sapiens | 22–23 Jan 2026</title>
  ...
  <style>
    ...
    /* Main spacing after fixed header+nav */
    .hero{ padding: 220px 0 16px; }
    ...
    .section-title{ font-weight: 1000; margin: 0 0 8px; }
    ...
    .coord-name{ font-weight: 1000; white-space: nowrap; }
    .coord-num{
      font-weight: 1000;
      color: #0b1020;
...
<body>
        ...
        <div class="row g-3 align-items-center">
          <div class="col-lg-6">
            <div class="d-flex align-items-center gap-2 mb-2">
              <span class="tag"><i class="bi bi-camera-reels"></i> Photography &amp; Reel Making</span>
              <span class="tag"><i class="bi bi-calendar-event"></i> 22–23 Jan, 2026</span>
            </div>

            <h1 class="title">Mad Moments</h1>
            <p class="subtitle">
              Document the fest with your lens — capture candid energy, events, performances, branding and moments.
            </p>

            <div class="d-flex flex-wrap gap-2 mt-3">
              <span class="tag"><i class="bi bi-person"></i> Individual Participation</span>
            ...
            <div class="d-flex flex-wrap gap-2 mt-4">
              ...
              <a class="btn btn-fun" href="#register"><i class="bi bi-qr-code-scan"></i> Register</a>
              <a class="btn btn-soft" href="#contacts"><i class="bi bi-telephone"></i> Contacts</a>
            </div>

            <div class="mt-3 small text-muted">
              Tip: If you are on phone, the Call / WhatsApp buttons below work instantly.
            </div>
          </div>

          <div class="col-lg-6">
            <!-- ✅ Put your poster image file here (NO pdf) -->
            <img class="poster" src="MadMoments.png" alt="Mad Moments Poster">
            <div class="small text-muted mt-2">
              (If your poster file name is different, just rename it or update <b>MadMoments.png</b>.)
            </div>
          </div>
        </div>
      </div>
  ...
  <section id="about">
    <div class="container">
      <div class="card-fun p-3 p-md-4">
        ...
        <p class="section-sub">What you will do in Mad Moments.</p>

        <ul class="list-check mb-0">
          <li>Step behind the lens to document the “Mad Moments” of marketing, auction, and designing events happening campus-wide.</li>
          <li>Participants must be on-ground for both Day 1 and Day 2 to capture the full energy of the fest.</li>
          <li>Unleash your signature style — use your best angles, transitions, and editing magic to tell the story of the fest.</li>
          <li>Winning and runner-up entries will be featured on the official Managenius website.</li>
        </ul>
      </div>
    </div>
  </section>
  ...
  <section id="rules">
    <div class="container">
      <div class="card-fun p-3 p-md-4">
        ...
        <p class="section-sub">Please follow these to stay eligible.</p>

        <ul class="list-check mb-0">
          <li>The video must capture the complete 2-day fest (Management Sapiens), including events, activities, performances, branding, and candid moments.</li>
          <li>It should present a creative and engaging story of the fest.</li>
          <li>All footage and editing must be original. Plagiarism or reused content is strictly prohibited.</li>
          <li>Any recording device may be used. External professional help or hired videographers are not allowed.</li>
          <li>Submit the final video in MP4 format as per the deadline given. Late entries will not be accepted.</li>
          <li>Consent must be taken from individuals featured prominently.</li>
          <li>Offensive or inappropriate content is not permitted.</li>
        </ul>
      </div>
    </div>
  </section>
  ...
  <footer class="footer footer-sticky">
    <div class="container d-flex flex-wrap justify-content-between align-items-center gap-2 py-3">
      <div>
        ...
        <div class="small text-muted">Proudly Powered by <b>IITM Software Development Cell</b></div>
      </div>
  ...
  <script>
    // Official registration link (same as index.php "mad")
    const REG_LINK = "https://forms.gle/RQCqxDaULZznBmCJ6";

    function goRegister(){
      window.open(REG_LINK, "_blank", "noopener");
    }
  </script>
