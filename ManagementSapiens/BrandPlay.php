<?php
/* BrandPlay.php
   ✅ Same header + navbar + footer + color scheme as index.php
   ✅ Poster shown (NO PDF link / NO PDF mention)
   ✅ Full event info + rules included (from your BrandPlay PDF)
*/
?>
<!doctype html>
<html lang="en">
<head>
  ...
  <title>Brand Play | Management Sapiens • 22–23 Jan 2026</title>
  ...
  <style>
    ...
    .poster-wrap{ display:flex; justify-content:center; align-items:center; }
    .poster{
      width: 100%;
      max-width: 520px;
      border-radius: 22px;
    ...
    .rule-list li{ margin-bottom: .55rem; }

    /* ✅ PERFECT contact alignment (no “improper alignment”) */
    .coordinator-list{ display: grid; gap: .6rem; }
    .coord-row{
      display: grid;
      grid-template-columns: minmax(120px, 160px) minmax(140px, 170px) 96px 120px;
      align-items: center;
      gap: .6rem;
      padding: .5rem .6rem;
      border-radius: 16px;
    ...
    @media (max-width: 576px){
      ...
      .coord-num{ grid-column: 1 / -1; justify-self: start; }
    }
...
<body id="top">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="nav">
        <ul class="navbar-nav ms-auto gap-lg-2">
          ...
          <li class="nav-item"><a class="nav-link fw-semibold" href="#details">Details</a></li>
        ...
        <div class="hero-inner">
          <div class="row g-3 align-items-center">
            <div class="col-lg-5">
              ...
              <h1 class="title">Brand Play</h1>
              <p class="subtitle">Where ideas clash &amp; strategies shine!</p>
              ...
              <div class="d-flex flex-wrap gap-2">
                <a class="btn btn-fun" href="#register"><i class="bi bi-qr-code-scan"></i> Register for Brand Play</a>
                <a class="btn btn-soft" href="index.php"><i class="bi bi-arrow-left"></i> Back to Home</a>
              </div>

              <div class="mt-3 small text-muted">
                Debate on real-world business scenarios: branding decisions, strategies, and market challenges.
              </div>
            </div>

            <div class="col-lg-7">
              <div class="poster-wrap">
                <!-- ✅ Put your poster image filename here -->
                <img class="poster" src="BrandPlay.png" alt="Brand Play Poster">
              </div>
              <div class="small text-muted mt-2 text-center">
                Tip: Save the poster and share on WhatsApp/Instagram.
              </div>
            </div>
  ...
  <section id="details">
    <div class="container">
      <div class="card-fun p-3 p-md-4">
        <h2 class="section-title mb-2">Event Info</h2>
        <p class="section-sub mb-2">
          Brand Play is a high-energy competitive event where teams debate on real-world business scenarios
          (company strategies, branding decisions, and market challenges) to demonstrate analytical thinking,
          communication, and persuasive skills.
        </p>
        <div class="d-flex flex-wrap gap-2 mt-2">
          <span class="tag"><i class="bi bi-diagram-3"></i> 3 Rounds</span>
          <span class="tag"><i class="bi bi-1-circle"></i> Round 1 &amp; 2: Day 1</span>
          <span class="tag"><i class="bi bi-2-circle"></i> Round 3: Day 2</span>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="rules">
    <div class="container">
      <div class="card-fun p-3 p-md-4">
        <h2 class="section-title mb-2">Rules &amp; Regulations</h2>
        <ul class="rule-list mb-0">
          <li>Topics for Round 1 will be shared one night before the debate.</li>
          <li>Round 1 includes group debates of 3 teams; only 1 team advances from each group.</li>
          <li>Companies for Round 2 will be announced 30 minutes before the round starts. Round 2 will be one-on-one debates between teams.</li>
          <li>Round 3 is a panel-style debate with shortlisted teams competing simultaneously.</li>
          <li>Judges will evaluate based on content, clarity, teamwork, and overall presentation, with strict time discipline and professionalism.</li>
        </ul>
      </div>
    </div>
  </section>
  ...
  <script>
    function goRegister(){
      const url = "https://forms.gle/ECCdwR1QzN6jd3jH9";
