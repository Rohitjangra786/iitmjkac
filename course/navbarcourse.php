  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item" style="margin-left: 5em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" style= "font-family: 'TradeGothicLTW01-Light';" href="#mba">MBA</a>
            </li>
              <li class="nav-item" style="margin-left: 5em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" style= "font-family: 'TradeGothicLTW01-Light';" href="#mca">MCA</a>
            </li>
            <li class="nav-item" style="margin-left: 5em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" href="#bca">BCA</a>
            </li>
            <li class="nav-item" style="margin-left: 5em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" href="#bba">BBA</a>
            </li>
            <li class="nav-item" style="margin-left: 5em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" href="#bcom">B.Com.(H)</a>
            </li>
              <li class="nav-item" style="margin-left: 5em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" href="#bjmc">BA(JMC)</a>
            </li>
