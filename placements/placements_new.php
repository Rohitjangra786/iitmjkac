...
?></div>
        <div class="banner">
          <h1 class="tgfmlt">Placements</h1>
          <button class="tgfmlt" onclick="window.location.href='#iipc'">Read More</button>
          <!--<button class="tgfmlt" onclick="window.location.href='#policy'">Placement Policy</button>-->
        </div>
      </header>
