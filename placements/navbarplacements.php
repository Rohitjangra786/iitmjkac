...
<nav class="navbar navbar-expand-lg" style="background-color: #F5CEAF;margin:0;padding:0;">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item" style="margin-left: 2em;margin-right: 2em;">
                <a class="nav-link color-maroon tgfmlt sl1" style= "font-family: 'TradeGothicLTW01-Light';" href="https://www.iitmjanakpuri.com/placements/placements.php#iipc">IIPC</a>
            </li>
            <li class="nav-item" style="margin-left: 2em;margin-right: 2em;">
                <a class="nav-link color-maroon tgfmlt sl1" href="https://www.iitmjanakpuri.com/placements/placements.php#part">Placement Partners</a>
            </li>
            <li class="nav-item" style="margin-left: 2em;margin-right: 2em;">
                <a class="nav-link color-maroon tgfmlt sl1" href="https://www.iitmjanakpuri.com/placements/placements.php#rec">Recruiters Speak</a>
            </li>
            <li class="nav-item" style="margin-left: 2em;margin-right: 2em;">
                <a class="nav-link color-maroon tgfmlt sl1" href="plrecords.php">Placement Records</a>
            </li>
            <li class="nav-item" style="margin-left: 2em;margin-right: 2em;">
                <a class="nav-link color-maroon tgfmlt sl1" href="summertraining.php">Summer Training Records</a>
            </li>
           <li class="nav-item" style="margin-left: 2em;margin-right: 2em;">
