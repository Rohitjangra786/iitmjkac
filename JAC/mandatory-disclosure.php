<?php
$jac_page_title = 'Institute Information';
$jac_active     = 'mandatory-disclosure.php';
...
?>
        <nav class="jac-crumb"><a href="https://www.iitmjanakpuri.com/index.php">Home</a> &rsaquo; Joint Assessment Committee &rsaquo; Institute Information</nav>
        <h1 class="jac-h1">Mandatory Disclosure</h1>
        <p class="jac-lead">Published by the Joint Assessment Committee of the Institute of Information Technology &amp; Management (IITM), Janakpuri, New Delhi, in accordance with AICTE norms for the academic year 2024&ndash;2025.</p>

        <h2 class="jac-h2">A. Institute Information</h2>
        ...
        <h2 class="jac-h2">Accreditation &amp; Statutory Documents</h2>
        <div class="doc-dl">
            <?php foreach ($jac_docs as $d): ?>
            <a href="<?php echo $d['href']; ?>" target="_blank" rel="noopener"><i class="fas <?php echo $d['icon']; ?>"></i> <?php echo $d['label']; ?></a>
            <?php endforeach; ?>
        </div>

        <h2 class="jac-h2">Disclosure Contents</h2>
        <div class="doc-index">
            <?php foreach ($jac_nav as $it): if ($it['href'] === 'mandatory-disclosure.php') continue; ?>
