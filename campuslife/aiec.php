...
<?php include('../navbartop.php'); ?>
      ...
      <section class="about-us">
        <div class="section-header">
          ...
          <div class="container">
              <h1 class="text-justify tgfmlt" style="color: #4b4b4b;">Artificial Intelligence Experience Centre</h1>
              <hr class="hr-maroon"/>
              <div class="container">
                  <div class="row">
                      <div class="col-md-2">
                            <img src="https://iitmjanakpuri.com/upload_new/ai.png" style="width: 100px; height: 80px;" />
                      </div>
                      <div class="col-md-10">
                          <p class="tgfmlt2 text-justify" style="color: #4b4b4b;font-size: 18px;">An Artificial Intelligence Experience Centre is being established at IITM as an initiative to promote Artificial Intelligence. The AI Experience Centre aims to train students and familiarize them with emerging technologies such as Python programming, Artificial Intelligence, Machine Learning, Deep Learning, Data Analytics, IoT, Robotics, Blockchain, and related fields. The cell organizes guest lectures, seminars, and workshops for students in these emerging areas. Students are encouraged to develop innovative applications of AI, Robotics, and Automation. The AIE cell also organizes project exhibitions and demonstration competitions for students to showcase and elaborate on their skills. The objective of this cell is to provide students with fundamental knowledge of all identified technologies and enrich them with the practical applications of Artificial Intelligence.<br>
                          
                         For more details <a href="https://iitmjanakpuriaiec.com" target="_blank"> Click Here</a>
