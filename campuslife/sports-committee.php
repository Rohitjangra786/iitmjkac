...
<?php include('../navbartop.php'); ?>
      ...
      <section class="about-us">
        <div class="section-header">
          ...
          <div class="container">
              <h1 class="text-justify tgfmlt" style="color: #4b4b4b;"> Sports Committee</h1>
              <hr class="hr-maroon"/>
              <div class="container">
                  <div class="row">
                      <div class="col-md-3">
                            <img src="images/extra/sports_day_logo.png" />
                      </div>
                      <div class="col-md-9">
                          <p class="tgfmlt2 text-justify" style="color: #4b4b4b;font-size: 18px;">To cultivate a sense of camaraderie and endorse sportsmanship within the Institute, a sports committee has been established. The primary objective of this committee is to stimulate student engagement in both indoor and outdoor sporting endeavors, thereby affording them opportunities for the enhancement of their physical capabilities, fortitude, and self-discipline.</p>
                          <p class="tgfmlt2 text-justify" style="color: #4b4b4b;font-size: 18px;">The IITM organizes an annual event known as the 'Sports Day' at the Hari Nagar DDA Sports Complex. This event provides students with the opportunity to engage in a variety of games, including basketball, volleyball, cricket, badminton, tennis, and table tennis. Furthermore, the Institute actively fosters sports involvement by urging its students to partake in sports events at the university level.</p>
                      </div>
                  </div>
              </div>
