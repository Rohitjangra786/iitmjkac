...
<?php include('../navbartop.php'); ?>
      ...
      <section class="about-us">
        <div class="section-header">
          ...
          <div class="container">
              <h1 class="text-justify tgfmlt" style="color: #4b4b4b;">Library Committee</h1>
              <hr class="hr-maroon"/>
              <div class="container">
                  <div class="row">
                      <div class="col-md-2">
                           <!-- <img src="https://iitmjanakpuri.com/upload/just_image/library.jpg" style="width: 100px; height: 80px;" /> -->
                      </div>
                      <div class="col-md-10">
                          <p class="tgfmlt2 text-justify" style="color: #4b4b4b;font-size: 18px;"><q><b>A well-stocked,
                          well-staffed library is like a gardener who plants
                          books, knowledge, and dreams and grows readers,
                          learners, and doers.</b></q></p>
                          <p class="tgfmlt" style="color: #4b4b4b;font-size: 18px;text-align: right;"><q><b>-Laura Purdie Salas</b></q></p>
          ...
          <div class="container">
              ...
              <div class="container">
                  <div class="row">
                      <div class="col-md-2">
                            <img src="https://iitmjanakpuri.com/upload_new/library.jfif" style="width: 100px; height: 80px;" />
                      </div>
                      <div class="col-md-10">
                          <p class="tgfmlt2 text-justify" style="color: #4b4b4b;font-size: 18px;">The Library Committee is responsible for ensuring that all students and faculty members have access to relevant study materials in a timely manner. The two libraries, catering to undergraduate (UG) and postgraduate (PG) students respectively, serve as repositories of diverse knowledge, housing extensive collections of books in Management and IT disciplines.</p>
                          <p class="tgfmlt2 text-justify" style="color: #4b4b4b;font-size: 18px;">All students, faculty members, and staff members have the privilege of utilizing a wide range of library services, including Circulation, Referencing, Indexing, Selective Dissemination of Information (SDI), Current Awareness Service (CAS), and Interlibrary Loan (ILL).</p>
