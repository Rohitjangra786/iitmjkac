...
<?php include('../navbartop.php'); ?>
      ...
      <section class="about-us">
        <div class="section-header">
          ...
          <div class="container">
              <h1 class="text-justify tgfmlt" style="color: #4b4b4b;">Research Committee</h1>
              <hr class="hr-maroon"/>
              <div class="container">
                  <div class="row">
                      <div class="col-md-2">
                            <img src="https://iitmjanakpuri.com/upload_new/research.jfif" style="width: 100px; height: 80px;" />
                      </div>
                      <div class="col-md-10">
                          <p class="tgfmlt2 text-justify" style="color: #4b4b4b;font-size: 18px;">The Research Committee at IITM is dedicated to stimulating and encouraging faculty members and students to make constructive contributions towards research and development. It consistently facilitates young students and faculty members to apply their intellectual capacity to deliver high-quality research. The committee aims to inspire individuals to share their new ideas and opinions through research papers, articles, case studies, reviews, etc., and present or publish them at the national and international levels. Additionally, faculty members are motivated to obtain research grants from various funding agencies, register as University Research Guides, chair sessions in seminars and conferences, and engage in other relevant activities. Some of the programs organized by the committee include Faculty Development Programs, Workshops, Management Development Programs, Symposiums, Conferences, and Seminars.</p>
