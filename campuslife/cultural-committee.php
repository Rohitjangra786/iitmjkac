...
<?php include('../navbartop.php'); ?>
      ...
      <section class="about-us">
        <div class="section-header">
          ...
          <div class="container">
              <h1 class="text-justify tgfmlt" style="color: #4b4b4b;"> Cultural Committee</h1>
              <hr class="hr-maroon"/>
              <div class="container">
                  <div class="row">
                      <div class="col-md-2">
                            <img src="https://iitmjanakpuri.com/upload_new/cultural.jpg" style="width: 100px; height: 80px;" />
                      </div>
                      <div class="col-md-10">
                          <p class="tgfmlt2 text-justify" style="color: #4b4b4b;font-size: 18px;">The Cultural Committee coordinates a diverse array of cultural events throughout the academic year, with the overarching aim of fostering and celebrating the cultural spirit of India, encapsulated by the principle of 'Unity in Diversity'. Students are actively encouraged to exhibit their multifaceted talents across various platforms, including the annual cultural fest 'IITM Fiesta', 'Anugoonj', Annual Day festivities, Fresher's Party, and Founder’s Day celebrations.</p>
