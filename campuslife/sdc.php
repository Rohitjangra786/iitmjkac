...
<?php include('../navbartop.php'); ?>
      ...
      <section class="about-us">
        <div class="section-header">
          ...
          <div class="container">
              <h1 class="text-justify tgfmlt" style="color: #4b4b4b;">Software Development Cell</h1>
              <hr class="hr-maroon"/>
              <div class="container">
                  <div class="row">
                      <div class="col-md-2">
                            <img src="https://iitmjanakpuri.com/upload_new/sdc.png" style="width: 100px; height: 80px;" />
                      </div>
                      <div class="col-md-10">
                          <p class="tgfmlt2 text-justify" style="color: #4b4b4b;font-size: 18px;">The Cell provides a platform for conducting software development activities in modern computer science and IT fields for both students and faculty members. Faculty members also impart practical training on various software applications to students. Furthermore, the Cell organizes short-term skill enhancement workshops to enhance participants' understanding of contemporary IT trends, thereby better preparing them for careers in the IT domain.
