  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item" style="margin-left: 5em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" style= "font-family: 'TradeGothicLTW01-Light';" href="#cmpl">Students' Testimonials </a>
            </li>
            <li class="nav-item" style="margin-left: 5em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" href="#extcr">Committees</a>
            </li>
            <li class="nav-item" style="margin-left: 5em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" href="#fitness">Executive Fitness Programme</a>
            </li>
            <li class="nav-item" style="margin-left: 5em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" href="images/Guidepg.pdf" target="_blank">Student Guide Book-PG</a>
            </li>
