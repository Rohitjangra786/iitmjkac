...
<?php include('../navbartop.php'); ?>
      ...
      <section class="about-us">
        <div class="section-header">
          ...
          <div class="container">
              <h1 class="text-justify tgfmlt" style="color: #4b4b4b;">Event Management Committee</h1>
              <hr class="hr-maroon"/>
              <div class="container">
                  <div class="row">
                      <div class="col-md-2">
                            <img src="https://iitmjanakpuri.com/upload_new/event_mgmt.jpg" style="width: 100px; height: 80px;" />
                      </div>
                      <div class="col-md-10">
                          <p class="tgfmlt2 text-justify" style="color: #4b4b4b;font-size: 18px;">The Event Management Committee encourages the conversion of theoretical knowledge into practical application by overseeing a range of multi-dimensional activities. These meticulously planned and diverse activities are designed to ensure that students actively engage in events of varying scales, thereby gaining a comprehensive understanding of event management intricacies. Organizing a variety of events provides valuable experience in planning and execution tailored to the target audience. This includes budgeting, theme development, and coordinating the necessary equipment to bring the event to fruition.</p>
