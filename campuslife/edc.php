...
<?php include('../navbartop.php'); ?>
      ...
      <section class="about-us">
        <div class="section-header">
          ...
          <div class="container">
              <h1 class="text-justify tgfmlt2" style="color: #4b4b4b;">Entrepreneurship Development Cell - SAMRIDDHI</h1>
              <hr class="hr-maroon"/>
              <div class="container">
                  <div class="row">
                      <div class="col-md-2">
                            <img src="https://iitmjanakpuri.com/upload_new/ed.jfif" style="width: 100px; height: 80px;" />
                      </div>
                      <div class="col-md-10">
                          <p class="tgfmlt2 text-justify" style="color: #4b4b4b;font-size: 18px;">Samriddhi aims to cultivate an environment that inspires students to embark on new ventures. The entrepreneurial spirit is nurtured through both formal and informal programs, addressing the needs of aspiring entrepreneurs by raising awareness about the technical know-how necessary to initiate an enterprise.</p>
                          
                           <p class="tgfmlt2 text-justify" style="color: #4b4b4b;font-size: 18px;">Samriddhi has undertaken a variety of activities including Entrepreneurship Awareness Programs, Entrepreneurship Development Programs, Inter-College Business Plan Competitions, and CEO Talks. Furthermore, Samriddhi has facilitated guest lectures by emerging entrepreneurs to inspire students to translate their innovative ideas into tangible products and services.</p>
                          
                           <p class="tgfmlt2 text-justify" style="color: #4b4b4b;font-size: 18px;">IITM collaborates with the National Institute for Entrepreneurship and Small Business Development (NIESBUD) and the National Small Industries Corporation (NSIC) to conduct entrepreneurial programs.</p>
