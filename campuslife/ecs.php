...
<?php include('../navbartop.php'); ?>
      ...
      <section class="about-us">
        <div class="section-header">
          ...
          <div class="container">
              <h1 class="text-justify tgfmlt" style="color: #4b4b4b;"> NSS & Community Service Committee</h1>
              <hr class="hr-maroon"/>
              <div class="container">
                  <div class="row">
                      <div class="col-md-2">
                            <img src="https://iitmjanakpuri.com/upload_new/ecs.gif" style="width: 100px; height: 80px;" />
                      </div>
                      <div class="col-md-10">
                          <p class="tgfmlt2 text-justify" style="color: #4b4b4b;font-size: 18px;">The committee diligently endeavors to raise awareness among students, faculty members, staff, and the immediate neighborhood community regarding general cleanliness and environmental preservation. Through regular organization of environment awareness programs, the committee aims to disseminate knowledge about the imperative for eco-friendly behavior, initiatives such as tree plantations, and the facilitation of blood donation camps.</p>
