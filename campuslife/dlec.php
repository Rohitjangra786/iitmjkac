...
<?php include('../navbartop.php'); ?>
      ...
      <section class="about-us">
        <div class="section-header">
          ...
          <div class="container">
              <h1 class="text-justify tgfmlt" style="color: #4b4b4b;">Debate and Literary Events Committee</h1>
              <hr class="hr-maroon"/>
              <div class="container">
                  <div class="row">
                      <div class="col-md-2">
                            <img src="https://iitmjanakpuri.com/upload_new/deb.jpeg" style="width: 100px; height: 80px;" />
                      </div>
                      <div class="col-md-10">
                          <p class="tgfmlt2 text-justify" style="color: #4b4b4b;font-size: 18px;">The committee endeavors to instill a fervor for quizzing, debating, creative writing, literature, and elocution among the students. The events organized by the committee serve to enhance students' creativity and logical thinking skills, while also encouraging independent research, thereby preparing them to explore realms beyond technology.</p>
