...
<html lang="en">
 ...
 <link rel="canonical" href="https://www.iitmjanakpuri.com/Library/libraryservices.php" />
    <!-- Bootstrap CSS -->
...
<li><span class="intro">Circulation Service – One can get three books issued on his/her ID card for one week, which can be renewed for further one week, if there is no demand. </span></li>
<li><span class="intro">Library Fine: One Rupee Per Day </li>
<li><span class="intro">Circulation of Periodicals - Journals are also issued for one week. As the library is having more than 72 journals for both management and IT field in hard copy, these are displayed in both the UG & PG library with their back volumes. Students can get these journals issued for one week. </span></li>
<li><span class="intro">Book Bank Service – Book Bank titles are issued for one full semester which have to be returned within a week after the end of exams enabling them to get the books for next semester. </span></li>
<li><span class="intro">Reservation of Books – Books can also be reserved by the students, if the book which they want is not available at that point of time. </li>
<li><span class="intro">Reference Service - There is a reference sections in both the libraries for UG and PG students. Books can be referred from the reference section with in the library premises. Reference books cannot be issued to any student.</span></li>
<li><span class="intro">Online Public Access Catalogue (OPAC) – One can search the catalogue for books through various approaches, such as Author, Title, Subject and many other approaches.</li>
<li><span class="intro">Library Feedback Form Service – If you want to give any suggestions with regard to improvement in the library, library feedback forms are available in print in both the UG and PG library. You can fill the form and submit it in the library.</span></li>
</ul>
