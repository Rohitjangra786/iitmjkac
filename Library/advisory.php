...
<html lang="en">
 ...
 <link 
    ...
    <link rel="stylesheet" href="css/owl.carousel.min.css">
     ...
     <link rel="canonical" href="https://www.iitmjanakpuri.com/Library/advisory.php" />
...
<div class="container">
    <div class="row">
        <div class="col-md">
            ...
            <div style="padding: 10px;text-align: justify;font-size: 20px;">
                A very effective and proficient Library Committee comprising of Librarian and Head
                of the Departments, as its members is constituted to discuss and 
                finalize the infrastructural and academic requirements of the library. It jointly discusses the requirements
                of the faculty & students to ensure maximum utilization of 
                the library resources and ensures the knowledge base is available as per the needs of the users. 
                
            </div>
            <h2>Library Committee Members</h2>
            <div style="padding: 10px;text-align: justify;font-size: 20px;">
               Coordinator: Dr. Dipti Gulati<br>
                <b>Members:</b><br>
                Dr. Ganesh Kumar Wadhwani, HOD-MCA & BCA<br>
                Dr. Deepika Arora, HOD-MBA<br>
                Dr. Deepali Saluja, HOD – BBA<br>
                Dr. Vikas Bharara, HOD-BCOM<br>
                Dr. Nivedita Sharma, HOD-BA(JMC)
