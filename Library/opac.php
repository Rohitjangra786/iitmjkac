    ...
    <style>
     body {
        ...
        .resource-box {
            padding: 20px;
            margin: 15px 0;
            background: linear-gradient(to right, #cce5ff, #ffffff);
            border-radius: 10px;
            font-weight: bold;
            text-align: center;
...
<div class="container">
    <div class="row">
        <div class="col-md">
            ...
            <div class="container">
                <div class="row">
                     <div class="col-md" style="margin: auto 0;">
               <div class="container mt-5">
        <h2 class="text-center">Library Resources</h2>
        <div class="resource-box">Fully Air Conditioned Reading Rooms</div>
        <div class="resource-box">44743 Volumes with 6193 Titles</div>
        <div class="resource-box">76 National and International Journals</div>
        <div class="resource-box">12 Magazines</div>
        <div class="resource-box">11 Newspapers with 42 Copies</div>
        <div class="resource-box">Wi-Fi/Internet Facility on 16 Computers</div>
        <div class="resource-box">Online Document Search via Web-OPAC</div>
        <div class="resource-box">Scanning & Reprographic Facility</div>
        <div class="resource-box">Online Access to DELNET & NDL</div>
        <div class="resource-box">E-Books Subscription: DELNET, World E-Book Library, Kindle Unlimited</div>
    </div>
            </div>
                </div>
            </div>
