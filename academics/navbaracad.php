...
<nav class="navbar navbar-expand-lg">
  ...
  <button class="navbar-toggler tgfmlt color-maroon custom-toggler ml-auto" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo_acad" aria-controls="navbarTogglerDemo_acad" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon custom-toggler show"></span>
  </button>
  <div class="collapse navbar-collapse" id="navbarTogglerDemo_acad">
    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item" style="margin-left: 3em;margin-right: 3em;">
                <a class="nav-link color-white tgfmlt sl1" style= "font-family: 'TradeGothicLTW01-Light';" href="#acad">Pedagogy</a>
            </li>
            <li class="nav-item" style="margin-left: 3em;margin-right: 3em;">
                <a class="nav-link color-white tgfmlt sl1" href="#skill">Skill Development</a>
            </li>
            <li class="nav-item" style="margin-left: 3em;margin-right: 3em;">
                <a class="nav-link color-white tgfmlt sl1" href="#syl">Syllabus</a>
            </li>
            <li class="nav-item" style="margin-left: 3em;margin-right: 3em;">
                <a class="nav-link color-white tgfmlt sl1" href="publications.php">Publications</a>
            </li>
            <li class="nav-item" style="margin-left: 3em;margin-right: 3em;">
                <a class="nav-link color-white tgfmlt sl1" href="images/Committee List2024_25.pdf" target="_blank">Committees</a>
            </li>
            <li class="nav-item" style="margin-left: 3em;margin-right: 3em;">
                <a class="nav-link color-white tgfmlt sl1" href="images/nt020724604 (3).pdf" target="_blank">Academic Calendar</a>
            </li>
            <!--<li class="nav-item" style="margin-left: 3em;margin-right: 3em;">
                <a class="nav-link color-white tgfmlt sl1" href="learningresources.php" target="_blank">Learning Resources</a>
            </li>-->
