  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item" style="margin-left: 2em;margin-right: 2em;">
                ...
                <a class="nav-link color-white tgfmlt sl1" style= "font-family: 'TradeGothicLTW01-Light';" href="#extra">Extra & Co-Curricular Events</a>
            </li>
            <li class="nav-item" style="margin-left: 2em;margin-right: 2em;">
                <a class="nav-link color-white tgfmlt sl1" style= "font-family: 'TradeGothicLTW01-Light';" href="#guest">Guest Lectures</a>
            </li>
            <li class="nav-item" style="margin-left: 2em;margin-right: 2em;">
                <a class="nav-link color-white tgfmlt sl1" style= "font-family: 'TradeGothicLTW01-Light';" href="#conf">Conference/Seminars/Webinars</a>
            </li>
            <li class="nav-item" style="margin-left: 2em;margin-right: 2em;">
                <a class="nav-link color-white tgfmlt sl1" style= "font-family: 'TradeGothicLTW01-Light';" href="#fdp">FDP</a>
            </li>
            <li class="nav-item" style="margin-left: 2em;margin-right: 2em;">
                <a class="nav-link color-white tgfmlt sl1" style= "font-family: 'TradeGothicLTW01-Light';" href="#indus">Industrial Visits</a>
            </li>
           <li class="nav-item" style="margin-left: 2em;margin-right: 2em;">
                <a class="nav-link color-white tgfmlt sl1" style= "font-family: 'TradeGothicLTW01-Light';" href="#workshops">Workshops</a>
            </li>
            <li class="nav-item" style="margin-left: 2em;margin-right: 2em;">
                <a class="nav-link color-white tgfmlt sl1" style= "font-family: 'TradeGothicLTW01-Light';" href="fiesta.php">Fiesta</a>
            </li>
