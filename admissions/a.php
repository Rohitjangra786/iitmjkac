      <div class="container">
              ...
              <hr class="hr-maroon"/>
                 ...
                 <p class="tgfmlt2 text-size-20" style="color: #4b4b4b;">Admissions are conducted solely on the basis of merit through a Common Entrance Test (CET) conducted by the GGSIP University. The University conducts centralised online counselling for all colleges affiliated with it.
                  ...
                  <p class="tgfmlt2 text-size-20" style="color: #4b4b4b;">For application forms students should look at the University’s advertisements in national newspapers or on its website :<a href="https://ipu.admissions.nic.in/" target="_blank">www.ipuadmissions.nic.in</a> or <a href="http://www.ipu.ac.in/" target="_blank">www.ipu.ac.in</a></p> 

                  <!--<p class="tgfmlt2 text-size-20" style="color: #4b4b4b;">Click Here for Admission Prospectus</p>--></h2>
                  </div>
