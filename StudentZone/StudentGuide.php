...
<head>
    ...
    <title> Student Guide & Rule Book | IITM Janakpuri  </title>
    <meta name="description" content="Access the student guide and rule book at IITM Janakpuri for academic policies, campus guidelines, student support, and essential resources.">
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-9">
            <h1 id="iipc">Student Guide/Rule Book</h1>
        </div>
    </div>
    <div class="row">
...
<div class="col-md-9">
    <div class="text-center mt-4">
        <h2 class="mb-4">Access Student Guides</h2>
        <a href="https://www.iitmjanakpuri.com/campuslife/images/Guideug.pdf" target="_blank" class="btn btn-lg btn-primary m-2" style="background-color: #800000; color: white; border: none; border-radius: 25px; padding: 15px 30px; font-size: 18px;">
            Student Guide - UG
        </a>
        <a href="https://www.iitmjanakpuri.com/StudentZone/pdf/Guidepg.pdf" target="_blank" class="btn btn-lg btn-secondary m-2" style="background-color: #800000; color: white; border: none; border-radius: 25px; padding: 15px 30px; font-size: 18px;">
            Student Guide - PG
        </a>
    </div>
</div>
