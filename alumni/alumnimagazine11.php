...
?></div>
        <div class="banner">
          <h1 class="tgfmlt">Alumni Magazine</h1>
          <button class="tgfmlt" onclick="window.location.href='#mag'">Read More</button>
        </div>
      </header>
      ...
      <section class="about-us">
        <div class="section-header">
          ...
          <h1 class="section-heading" id="mag">Alumni Magazine</h1>
          ...
          <div class="container">
              ...
              <hr class="hr-maroon"/>
              <h2 class="text-justify tgfmlt" style="color: #4b4b4b;">ESSENCE - Alumni Magazine is an annual publication released by 
              IITM Alumni Association. Main motive is to stay connected with our beloved Alumni and it also serves a 
              purpose to connect our Alumni with their junior batches in the Institute currently pursuing respective courses. It gives a
              unique platform to our Alumni to share valuable experience & thoughts with their juniors and fellow Alumni too.</h2>
              <h2>We look forward to many more fruitful points of connect with our Alumni.</h2>
         <!--     <h2>
                  <a href="magazines/Essence_vol1.pdf" target="_blank">Volume 1 : Academic Session 2020-21</a>
              </h2>
              <h2>
                  <a href="magazines/Essence_vol1.pdf" target="_blank">Volume 2 : Academic Session 2021-22</a>
              </h2> -->
       <!--         <div class="row">
    <div class="col-md-6">
      <a href="magazines/Essence_vol1.pdf" target="_blank">
        <img src="magazines/vol1.png" class="img-fluid" alt="Image 1">
      </a>
      <h2>
        <a href="magazines/Essence_vol1.pdf" target="_blank">Volume 1 : Academic Session 2020-21</a>
      </h2>
    ...
    <div class="col-md-6">
      <a href="magazines/Essence_vol2.pdf" target="_blank">
        <img src="magazines/vol2.png" class="img-fluid" alt="Image 2">
      </a>
      <h2>
