...
<nav class="navbar navbar-expand-lg">
    <a class="navbar-brand color-white tgfmlt" onmouseover="somelinks(this)" onmouseout="normallinks(this)" href="https://www.iitmjanakpuri.com/index.php"><img src="../upload_new/gallery/logow.png" class="logow" id="logom" style="width: 9.2rem; height: 5.2rem;"/>
   <!-- <p class="tgfmlt" style="font-size: 0.8rem;line-height:1;">Institute of Information </br>Technology and Management</p> -->
    </a>
    <div class="container text-center">
  <button class="navbar-toggler tgfmlt color-maroon custom-toggler ml-auto" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo_alm" aria-controls="navbarTogglerDemo_alm" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon custom-toggler hamburger-icon">
        <div class="line"></div>
  <div class="line"></div>
  <div class="line"></div>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo_alm">
    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item" style="margin-left: 2em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" style= "font-family: 'TradeGothicLTW01-Light';" href="https://iitmjanakpuri.com/alumni/alumni.php">Alumni Association</a>
            </li>
            <li class="nav-item" style="margin-left: 2em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" href="notablem.html">Notable Alumni</a>
            </li>
            <li class="nav-item" style="margin-left: 2em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" href="meets.php">Alumni Meets</a>
            </li>
            <li class="nav-item" style="margin-left: 2em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" href="speak.php">Alumni Speak</a>
            </li>
            <!--<li class="nav-item" style="margin-left: 2em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" href="alumniregistration.php">Alumni Registration</a>
            </li>-->
           <li class="nav-item" style="margin-left: 2em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" href="https://iitmjanakpuri.com/alumni/alumnimagazine.php">Alumni Magazine</a>
            </li>
