...
<footer class="aac-foot">
    ...
    <div class="bar">&copy; <?php echo date('Y'); ?> IITM Janakpuri &middot; Academic Audit Cell. All rights reserved.</div>
</footer>

<button class="aac-top" id="aacTop" aria-label="Back to top"><i class="fas fa-arrow-up"></i></button>
...
(function(){
    document.addEventListener('DOMContentLoaded', function(){
        ...
        if (window.AOS){
            var sel = '.aac-main > h1, .aac-main > h2, .aac-main > h3, .aac-main > p, .aac-main > .aac-lead,'
                    + '.aac-main > table, .aac-main > .doc-scroll, .aac-main > .doc-index, .aac-main > .doc-dl, .aac-main > .doc-grid,'
                    + '.aac-main > figure, .aac-main > ul, .aac-main > ol, .aac-main > blockquote, .aac-main > .doc-note';
            var n = 0;
        ...
        // Back-to-top
        var btn = document.getElementById('aacTop');
        if (btn){
        ...
        var toc = document.querySelector('.aac-toc');
        if (toc){
