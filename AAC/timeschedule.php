...
?></div>
        <div class="banner">
          <h1 class="tgfmlt">Adherence of Time Schedule</h1>
      ...
      <section class="about-us">
        <div class="section-header">
          <h1 class="section-heading text-center" id="sch">Adherence of Time Schedule </h1>
          <div class="underline"></div>
          <div class="container">
<button class="collapsible" onclick="toggleCollapsible('conference')">Adherence of Time Schedule</button>
<div class="content" id="conference">
  <table class="table table-bordered table-striped table-hover">
    <thead>
      <tr>
        <th  colspan="4" class="h1">Adherence of Time Schedule</th>
      </tr>
    </thead>
    <tbody>
      <!-- Rows 1-18 -->
    ...
    <tr>
        <td>Adherence of time schedule for 1st and 2nd Shift Programmes</td>
        <td>Yes</td>
        <td>For institutions, not adhering to schedule, ask for written explanations.</td>
        <td></td>
    </tr>
    </tbody>
  </table>
