...
?></div>
        <div class="banner">
          <h1 class="tgfmlt">Co-Curricular Activities</h1>
      ...
      <section class="about-us">
        <div class="section-header">
          <h1 class="section-heading" id="sch">Co-Curricular Activities</h1>
          <div class="underline"></div>
          <div class="container">
<button class="collapsible" onclick="toggleCollapsible('conference')">Conference</button>
<div class="content" id="conference">
    <p class='h2'><a href="pdf/Conference.pdf" target="_blank">Conference</a></p>
</div>

<button class="collapsible" onclick="toggleCollapsible('seminars')">Seminars</button>
<div class="content" id="seminars">
    <p class='h2'><a href="pdf/Seminar.pdf" target="_blank">Seminars</a></p>
</div>

<button class="collapsible" onclick="toggleCollapsible('workshops')">Workshops</button>
<div class="content" id="workshops">
    <p class='h2'><a href="pdf/Workshop.pdf" target="_blank">Workshops</a></p>
</div>

<button class="collapsible" onclick="toggleCollapsible('fdp')">Faculty Development Programs</button>
<div class="content" id="fdp">
    <p class='h2'><a href="pdf/FDP.pdf" target="_blank">Faculty Development Programs</a></p>
</div>

<button class="collapsible" onclick="toggleCollapsible('guest')">Guest Lectures</button>
<div class="content" id="guest">
    <p class='h2'><a href="pdf/GuestLecture.pdf" target="_blank">Guest Lectures</a></p>
</div>

<button class="collapsible" onclick="toggleCollapsible('skill')">Skill Enhancement Workshops</button>
<div class="content" id="skill">
    <p class='h2'><a href="pdf/SkillWorkshop.pdf" target="_blank">Skill Enhancement Workshops</a></p>
</div>
