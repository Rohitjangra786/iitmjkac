...
?></div>
        <div class="banner">
          <h1 class="tgfmlt">Status of Accreditation</h1>
          <button class="tgfmlt" onclick="window.location.href='#acd'">Read More</button>
        </div>
      </header>
      ...
      <section class="about-us">
        <div class="section-header">
          <h1 class="section-heading" id="acd">Status of Accreditation</h1>
          <div class="underline"></div>
          <div class="container">
<button class="collapsible" onclick="toggleCollapsible('app')">Applicability of Accreditation</button>
<div class="content" id="app">
      <table class="table table-hover table-bordered">
    <tbody>
      <!-- First row with 1 column spanning 2 columns -->
      <tr>
        <td colspan="2" class="h2 font-weight-bold" style="font-size: larger;">(a) Applicability of Accreditation</td>
      </tr>

      <!-- Second row with 2 columns (30% and 70% width) -->
      <tr>
        <td style="width: 30%;">NBA Only</td>
        <td style="width: 70%;">No</td>
      </tr>

      <!-- Third row with 2 columns (30% and 70% width) -->
      <tr>
        <td style="width: 30%;">NAAC Only</td>
        <td style="width: 70%;">No</td>
      </tr>

      <!-- Fourth row with 2 columns (30% and 70% width) -->
      <tr>
        <td style="width: 30%;">NBA and NAAC</td>
        <td style="width: 70%;">Yes&nbsp;&nbsp;&nbsp;&nbsp; <a href="pdf/NAAC Certificate.pdf" target="_blank">NAAC</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="pdf/NBA Certificate.pdf" target="_blank">NBA</a></td>
      </tr>
    </tbody>
  </table>
</div>

<button class="collapsible" onclick="toggleCollapsible('ststus')">Status of Accreditation</button>
<div class="content" id="ststus">
   <p class="h2">
 <table class="table table-hover table-bordered">
    <tbody>
      <!-- First row with 1 column spanning 2 columns -->
      <tr>
        <td colspan="2" class="h2 font-weight-bold" style="font-size: larger;">(b) Status of Accreditation</td>
      </tr>

      <!-- Second row with 2 columns (30% and 70% width) -->
      <tr>
        <td style="width: 30%;">NBA
(Out of 25 scaled to 50, if only NBA accreditation applicable)
</td>
        <td style="width: 70%;">XXXX</td>
      </tr>

      <!-- Third row with 2 columns (30% and 70% width) -->
      <tr>
        <td style="width: 30%;">NAAC
(Out of 25 scaled to 50, if only NAAC accreditation is applicable)
</td>
        <td style="width: 70%;">XXXX</td>
      </tr>
      ...
      <!-- Fourth row with 2 columns (30% and 70% width) -->
      <tr>
        <td style="width: 70%;">NBA and NAAC
(Out of 50, if both NAAC & NBA accreditation are applicable and marks would be awarded as per availability of accreditations, out of total of ‘25’ marks each for NBA and NAAC)
</td>
        <td style="width: 30%;">NAAC 'A' Grade<br>NBA (2025-2028)</td>
      </tr>
      <tr>
          <td class="text-right">Marks (Max. Marks: 50)</td>
          <td></td>
      </tr>
    </tbody>
  </table>
