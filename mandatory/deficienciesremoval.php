...
?></div>
        <div class="banner">
          <h1 class="tgfmlt">Removal / Completions of Identified Deficiencies</h1>
      ...
      <section class="about-us">
        <div class="section-header">
          <h1 class="section-heading text-center" id="sch">Removal / Completions of Identified Deficiencies </h1>
          <div class="underline"></div>
          <div class="container">
<button class="collapsible" onclick="toggleCollapsible('conference')">Removal / Completions of Identified Deficiencies</button>
<div class="content" id="conference">
  <table class="table table-bordered table-striped table-hover">
    <thead>
      <tr>
        <th  colspan="6" class="h1">15.  Removal / Completions of Identified Deficiencies</th>
      </tr>
    </thead>
    <tbody>
      <!-- Rows 1-18 -->
     <tr>
        <td  colspan="6" class="h1">Removal / Completions of deficiencies, as identified in previous Academic Audit (If last year, there was no audit, then no marks to be awarded, and the maximum marks component of this parameter not to be counted in total marks). Only deficiencies, as deviations from the standard norms, to be considered.</td>
      </tr>
    <tr>
        <td colspan="3"></td>
        <td>No.</td>
    ...
    <tr>
        <td>(i)</td>
        <td>No. of deficiencies identified in last report (a)</td>
        <td width="2%"></td>
        <td>3</td>
    ...
    <tr>
        <td>(ii)</td>
        <td>No of deficiencies removed / completed (b)</td>
        <td width="2%"></td>
        <td>3</td>
        <td><a href="pdf/Compliance.pdf" target="_blank">View Details</a></td>
        <td></td>
    </tr>
    <tr>
        <td></td>
