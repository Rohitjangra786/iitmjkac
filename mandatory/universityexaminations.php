...
?></div>
        <div class="banner">
          <h1 class="tgfmlt">Institutional Support for University Examinations </h1>
      ...
      <section class="about-us">
        <div class="section-header">
          <h1 class="section-heading" id="ins">Institutional Support for University Examinations </h1>
          <div class="underline"></div>
          <div class="container">
<button class="collapsible" onclick="toggleCollapsible('supp')">Institutional Support for University Examinations </button>
<div class="content" id="supp">
  <table class="table table-bordered table-striped table-hover">
    <thead>
      <tr>
        <th  colspan="5" class="h1">6.  Institutional Support for University Examinations (during the Assessment Year)</th>
      </tr>
    </thead>
    <tbody>
      <!-- Rows 1-18 -->
      ...
      <tr>
        <td>6</td>
        <td width="50%" class="text-justify">Percentage of faculty participation in university examinations as evaluators / university representatives</td>
        <td width="2%"></td>
        <td>80% Faculty have participated  <a href="pdf/6(Exams Support).pdf" target="_blank">View Details</a></td>
        <td></td>
      </tr>
