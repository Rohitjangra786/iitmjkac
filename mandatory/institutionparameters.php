...
?></div>
        <div class="banner">
          <h1 class="tgfmlt">General Parameters about the Institution </h1>
      ...
      <section class="about-us">
        <div class="section-header">
          <h1 class="section-heading text-center" id="sch">General Parameters about the Institution </h1>
          <div class="underline"></div>
          <div class="container">
<button class="collapsible" onclick="toggleCollapsible('conference')">General Parameters about the Institution </button>
<div class="content" id="conference">
  <table class="table table-bordered table-striped table-hover">
    <thead>
      <tr>
        <th  colspan="6" class="h1">13. General Parameters about the Institution</th>
      </tr>
    </thead>
    <tbody>
      <!-- Rows 1-18 -->
    <tr>
        <td colspan="5">Upload pictures under mandatory disclosures on the website</td>
        <td>Details</td>
        <td>Marks</td>
    </tr>
    <tr>
        ...
        <td  width="5%">(i)</td>
        <td>Individual seating arrangements for faculty with suitable furniture</td>
        <td width="2%"></td>
        <td>Yes</td>
        <td><a href="pdf/13i Faculty Seating.pdf" target="_blank">View Details</a></td>
    </tr>
     <tr>
        <td  width="5%">(ii)</td>
        <td>Institution Website URL</td>
        <td width="2%"></td>
        <td>Yes</td>
        <td><a href="https://www.iitmjanakpuri.com/" target="_blank">IITM Janakpuri</a></td>
    </tr>
    <tr>
        <td  width="5%">(iii)</td>
        <td>Common rooms for girls (separate)</td>
        <td width="2%"></td>
        <td>Yes</td>
        <td><a href="pdf/13iii Girls common Room.pdf" target="_blank">View Details</a></td>
    </tr>
    <tr>
        <td  width="5%">(iv)</td>
        ...
        <td width="2%"></td>
        <td>Yes</td>
        <td><a href="pdf/13iv Cleanliness of Toilets.pdf" target="_blank">View Details</a></td>
    </tr>
    <tr>
        <td  width="5%">(v)</td>
        <td>Students’ canteen and drinking water arrangements</td>
        <td width="2%"></td>
        <td>Yes</td>
        <td><a href="pdf/13(v)Students Canteen and Drinking Water.pdf" target="_blank">View Details</a></td>
    </tr>
    <tr>
        <td></td>
        <td colspan="5" class="text-right">Marks (Maximum Marks: 30)</td>
    </tr>
    </tbody>
  </table>
</div>
