...
?></div>
        <div class="banner">
          <h1 class="tgfmlt">Status of Library</h1>
      ...
      <section class="about-us">
        <div class="section-header">
          <h1 class="section-heading" id="ins">Status of Library</h1>
          <div class="underline"></div>
          <div class="container">
<button class="collapsible" onclick="toggleCollapsible('books')">Books</button>
<div class="content" id="books">
  <table class="table table-bordered table-striped table-hover align-middle">
  <thead>
    <tr>
      <th colspan="6" class="h1">
        7 (a). Books<br>
        <small>Total Books Added During the Year: <strong>281</strong> | Total Volumes Added During the Year: <strong>2992</strong></small>
      </th>
    </tr>
    <tr>
      <th>S.No.</th>
  ...
  <tbody>
    <tr>
      ...
      <td>1933</td>
      <td>7939</td>
      <td><a href="pdf/7(a) Status of Books.pdf" target="_blank">View Details</a></td>
      <td></td>
    </tr>
    <tr>
      <td>2.</td>
    ...
    <tr>
      <td colspan="6" class="text-end fw-bold">Total Score</td>
    </tr>
    <tr>
      <td colspan="6" class="text-end fw-bold">Marks (Maximum Marks: 70)</td>
    </tr>
  </tbody>
</table>
...
<button class="collapsible" onclick="toggleCollapsible('jour')">Journals</button>
<div class="content" id="jour">
  <table class="table table-bordered table-striped table-hover">
    <thead>
      <tr>
        <th  colspan="5" class="h1">7 (b).  Journals</th>
      </tr>
    </thead>
    <tbody>
      <!-- Rows 1-18 -->
     <tr>
      ...
      <tr>
        ...
        <td>a=48</td>
        <td>a/12=4</td>
        <td rowspan="2" id='details-journal'><a href="pdf/7(b) Status of Journals.pdf" target="_blank">View Details</a></td>
        <td></td>
      </tr>
      <tr>
        <td>2. </td>
     ...
     <tr>
        <td></td>
        <td colspan="4" class="text-right">Marks (Maximum Marks: 30)</td>
        <td></td>
      </tr>
     <tr>
        <td></td>
        <td colspan="4" class="text-right">Total Marks (Maximum Marks: 100)</td>
        <td></td>
      </tr>
    </tbody>
  </table>
