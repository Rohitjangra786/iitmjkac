...
?></div>
        <div class="banner">
          <h1 class="tgfmlt">Academic Audits 2024-2025</h1>
          <button class="tgfmlt" onclick="window.location.href='#institute'">Read More</button>
        </div>
      </header>
      ...
      <section class="about-us">
        <div class="section-header">
          <h1 class="section-heading" id="institute">Institute Information</h1>
    ...
    <thead>
      <tr>
        <th scope="col" colspan="3" class="display-3">A.  Institute Information</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td>Name of the Institution</td>
        <td colspan="2">Institute of Information Technology & Management</td>
      </tr>
      <tr>
        <td>Name of the Director/Principal</td>
        <td colspan="2">Prof. (Dr.) Rachita Rana</td>
      </tr>
      <tr>
        <td rowspan="5">Address</td>
        <td colspan="2">D-29, Institutional Area, Janakpuri, New Delhi-110058</td>
      </tr>
      <tr>
        <td>Mobile No. 
(Director/Principal)
...
(Institution)
        ...
        <td>+91/011-28525882, 28520239, 28525051</td>
      </tr>
      <tr>
        <td>Email ID</td>
        <td>director@iitmipu.ac.in</td>
      </tr>
      <tr>
        <td>Institution website URL</td>
        <td>https://iitmjanakpuri.com/</td>
      </tr>
    </tbody>
  </table>
          ...
          <!--<div>
              <a href="pdf/Institute Award List.pdf" target="_blank" class="btn btn-primary btn-lg">Institute Awards</a>
          </div>-->
