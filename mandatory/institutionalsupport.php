...
?></div>
        <div class="banner">
          <h1 class="tgfmlt">Institutional Support for Faculty Development</h1>
      ...
      <section class="about-us">
        <div class="section-header">
          <h1 class="section-heading" id="ins">Institutional Support for Faculty Development</h1>
          <div class="underline"></div>
          <div class="container">
<button class="collapsible" onclick="toggleCollapsible('support')">Institutional Support for Faculty Development</button>
<div class="content" id="support">
  <table class="table table-bordered table-striped table-hover">
    <thead>
      <tr>
        <th  colspan="5" class="h1">4. Institutional Support for Faculty Development</th>
      </tr>
    </thead>
    <tbody>
      <!-- Rows 1-18 -->
      ...
      <tr>
        <td>4(a)</td>
        <td width="50%" class="text-justify">Documentary evidence of awards like best teacher / best researcher with implementation, etc. (Upload report) </td>
        <td width="2%"></td>
        <td><a href="pdf/4(a) Best faculty - research award.pdf" target="_blank">View Details</a></td>
        <td></td>
      </tr>
      <tr>
        <td>4(b)</td>
        <td width="50%" class="text-justify">Documentary evidence of mechanism and its utilisation for grant of study leave to teachers with full pay for faculty to pursue higher studies at other institutions
(Upload report with List)
</td>
        <td></td>
        <td><a href="pdf/4(b) Grant of study leave.pdf" target="_blank">View Details</a></td>
        <td></td>
      </tr>
      <tr>
        <td>4(c)</td>
        <td width="50%" class="text-justify">Documentary evidence of grant of funds to teachers to attend conferences, or seminars, or FDP, or workshops, etc. including registration fee, TA/DA, and grant of special casual leave or duty leave for this purpose
(Upload report with List)
</td>
        <td></td>
        <td><a href="pdf/4(c) List of Grant of fund to attend conference seminar etc.pdf" target="_blank">View Details</a></td>
        <td></td>
      </tr>
      <tr>
        <td>4(d)</td>
        <td width="50%" class="text-justify">Individual computing facilities with Internet provided to teachers</td>
        <td></td>
        <td>Yes (To all the teachers)</td>
        <td></td>
      </tr>
