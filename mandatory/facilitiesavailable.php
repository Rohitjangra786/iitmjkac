...
?></div>
        <div class="banner">
          <h1 class="tgfmlt">Facilities Available in the Institute </h1>
      ...
      <section class="about-us">
        <div class="section-header">
          <h1 class="section-heading text-center" id="sch">Facilities Available in the Institute </h1>
          <div class="underline"></div>
          <div class="container">
<button class="collapsible" onclick="toggleCollapsible('conference')">Facilities Available in the Institute </button>
<div class="content" id="conference">
  <table class="table table-bordered table-striped table-hover">
    <thead>
      <tr>
        <th  colspan="6" class="h1">14.  Other Facilities Available in the Institute (Based on Feedback)</th>
      </tr>
    </thead>
    <tbody>
      <!-- Rows 1-18 -->
    <tr>
        <td  width="5%" rowspan="6">14(a)</td>
        <td colspan="3"></td>
        <td width="20%">Details</td>
        <td>Marks</td>
    </tr>
    <tr>
        <td>Feedback from the Faculty/Employers</td>
        <td width="2%"></td>
        <td></td>
        <td></td>
        <td></td>
     ...
     <tr>
        ...
        <td width="2%"></td>
        <td>Yes</td>
        <td><a href="pdf/policyu.pdf" target="_blank">View Details</a></td>
    </tr>
    <tr>
        <td>Analysed:</td>
        <td width="2%"></td>
    ...
    <tr>
        <td>(on parameters like salary as per norms, leaves, research facility, recognition of their contributions, their respect, promotions, and overall academic environment)</td>
        <td width="2%"></td>
        <td></td>
        <td></td>
        <td></td>
     ...
     <tr>
        <td rowspan="5">14(b)</td>
        <td>Feedback from the Students/Alumni</td>
        <td width="2%"></td>
        <td></td>
        <td></td>
        <td></td>
     ...
     <tr>
        ...
        <td width="2%"></td>
        <td>Yes</td>
        <td><a href="pdf/14(b) Alumni_students feedback.pdf" target="_blank">View Details</a></td>
    </tr>
    <tr>
        <td>Analysed:</td>
        <td width="2%"></td>
    ...
    <tr>
        <td>(on parameters like teaching environment, regularity of classes, availability of teachers outside classes, support for conducting extra – curricular activities such as field visits, cultural festivals etc., administrative support, career guidance, counselling, support for training and placements, and student’s interaction with experts from industry and academia)</td>
        <td width="2%"></td>
        <td></td>
        <td></td>
        <td></td>
