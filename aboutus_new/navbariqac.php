  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item" style="margin-left: 5em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" style= "font-family: 'TradeGothicLTW01-Light';" href="#about">Composition</a>
            </li>
            <li class="nav-item" style="margin-left: 5em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" href="#vision">Minutes</a>
            </li>
            <li class="nav-item" style="margin-left: 5em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" href="#accr">Compliance Reports</a>
            </li>
            <li class="nav-item" style="margin-left: 5em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" href="#qp">AQAR</a>
            </li>
