...
?></div>
      ...
      <section class="about-us">
        <div class="section-header">
          <h1 class="section-heading" id="about">About Us</h1>
          ...
          <div class="container">
              ...
              <h1 class="section-heading" id="vision">Vision &amp; Mission</h1>
              <hr class="hr-maroon"/>
               <div class="row">
                  <div class="col-md">
...
<h3>Innovation</<h3>
               ...
               <!-- Quality Policy -->
              <h1 class="section-heading" id="qp">Quality Policy</h1>
              <hr class="hr-maroon"/>
               <div class="row">
                  <div class="col-md">
                      <h2 class="text-justify tgfmlt2" style="color: #4b4b4b;">
