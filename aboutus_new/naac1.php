...
<?php include('navbarnaac.php'); 
?></div>
        <div class="banner">
          <h1 class="tgfmlt">NAAC</h1>
      ...
      <section class="about-us">
        <div class="section-header">
          <h1 class="section-heading" id="about">Accreditation</h1>
          <div class="underline"></div>
          <div class="container">
              <div class="row">
                  <p><span class="text-justify tgfmlt" style="color: #4b4b4b;font-size: 2rem;">
                      The Institute of Information Technology and Management (IITM) 
                      has been rated grade ‘A’ by National Assessment and Accreditation Council (NAAC).</span></p>
              </div>
              <div style="height: 10vh;"></div>
              <h1 class="section-heading" id="vision">NAAC Certificate</h1>
              <hr class="hr-maroon"/>
               <div class="row">
                  <div class="col-md">
                      <embed src="../direct-file/naac.pdf" style="width:100%;height: 500px;" />
              ...
              <div style="height: 10vh;"></div>
              <!-- Compliance Reports -->
               <!-- <h1 class="section-heading" id="accr">Gallery</h1>
              <hr class="hr-maroon"/>
               <div class="row">
                  <div class="col-md">
     ...
     Gallery
		...
		<!--			<div class="row mt-10">
					...
					<div class="row">
                    	<div class="col-sm-4">
							<img src="../upload/naac/gallery/1.jpg" class="img-responsive" width="400" height="350" />
						</div>
						<div class="col-sm-4">
							<img src="../upload/naac/gallery/2.jpg" class="img-responsive" width="400" height="350" />
						</div>
						<div class="col-sm-4">
							<img src="../upload/naac/gallery/3.jpg" class="img-responsive" width="400" height="350"/>
						</div>
					</div> -->
              ...
              <div style="height:10vh;"></div>
              <!-- AQAR -->
              <h1 class="section-heading" id="qp">SSR</h1>
              <hr class="hr-maroon"/>
               <div class="row">
                  <div class="col-md">
                     <!-- SSR -->
                     <p><span class="text-justify tgfmlt" style="color: #4b4b4b;font-size: 2rem;"><a href="https://iitmjanakpuri.com/direct-file/SSR.pdf" target="_blank">SSR</a></span></p>
