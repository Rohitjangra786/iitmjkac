  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02" data-toggle="collapse" data-target=".navbar-collapse">
    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item" style="margin-left: 5em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" style= "font-family: 'TradeGothicLTW01-Light';" href="#about">About Us</a>
            </li>
            <li class="nav-item" style="margin-left: 5em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" href="#vision">Vision &amp; Mission</a>
            </li>
            <!--<li class="nav-item" style="margin-left: 5em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" href="#accr">Accreditations</a>
            </li>-->
            <li class="nav-item" style="margin-left: 5em;margin-right: 5em;">
                <a class="nav-link color-white tgfmlt sl1" href="#vision">Quality Policy</a>
            </li>
