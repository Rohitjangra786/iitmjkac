...
<nav class="navbar navbar-expand-lg">
  ...
  <button class="navbar-toggler tgfmlt color-maroon custom-toggler ml-auto" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo02" aria-controls="navbarTogglerDemo02" aria-expanded="false" aria-label="Toggle navigation">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item" style="margin-left: 3em;margin-right: 3em;">
                <a class="nav-link color-white tgfmlt sl1" style= "font-family: 'TradeGothicLTW01-Light';" href="https://www.iitmjanakpuri.com/faculty/faculty.php">Director</a>
            </li>
            <li class="nav-item" style="margin-left: 3em;margin-right: 3em;">
                <a class="nav-link color-white tgfmlt sl1" href="computersc.php">Dept. of Comp. Science</a>
            </li>
            <li class="nav-item" style="margin-left: 3em;margin-right: 3em;">
                <a class="nav-link color-white tgfmlt sl1" href="mgmtdept.php">Dept. of Mgmt. Studies</a>
            </li>
            <li class="nav-item" style="margin-left: 3em;margin-right: 3em;">
                <a class="nav-link color-white tgfmlt sl1" href="commercefa.php">Dept. of Commerce</a>
            </li>
          <li class="nav-item" style="margin-left: 3em;margin-right: 3em;">
                <a class="nav-link color-white tgfmlt sl1" href="masscom.php">IITM School of Mass Communication</a>
            </li>
