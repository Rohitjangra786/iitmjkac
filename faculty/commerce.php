        ...
        <div class="row">
          <div class="col-lg-3">
            <div class="card" style="height: 80%;width: 100%;border: 1px #fff solid;">
              <img
                src="images/commerce/vikass.jpg"
              ...
              <div class="card-body">
                ...
                <p class="card-text text-center">
                 <h3 class="tgfmlt text-center" style="color: #000; line-height: 1.5rem;font-size:1.3rem;">Head of Department</h3>
          ...
          <div class="col-lg-3">
            <div class="card" style="height: 80%;width: 100%;border: 1px #fff solid;">
              ...
              />
              <div class="card-body">
                <h5 class="card-title tgfmlt text-center" style="color: #000; line-height: 1.5rem;font-size:2rem;"><strong>Dr. Jyoti Bhambhani</strong></h5>
                <p class="card-text">
          ...
          <div class="col-lg-3">
            <div class="card" style="height: 100%;width: 100%;border: 2px #fff solid;">
              ...
              <div class="card-body">
                ...
                <p class="card-text">
                 <h3 class="tgfmlt text-center" style="color: #000; line-height: 1.5rem;font-size:1.3rem;">Assistant Professor</h3>
                 <h3 class="tgfmlt text-center" style="color: #000; line-height: 1.5rem;font-size:1.3rem;">B.Com(H), M.Com, UGC NET</h3>
...
<!---XXXX-->
        ...
        <!--- YYYY -->
          ...
          <div class="col-lg-3">
            <div class="card" style="height: 100%;width: 100%;border: 2px #fff solid;">
              <img
                src="images/commerce/shikha.jpg"
                class="card-img-top"
                alt="Waterfall" style="width: 100%;"
              />
              <div class="card-body">
                ...
                <p class="card-text">
                 <h3 class="tgfmlt text-center" style="color: #000; line-height: 1.5rem;font-size:1.3rem;">Assistant Professor</h3>
                 <h3 class="tgfmlt text-center" style="color: #000; line-height: 1.5rem;font-size:1.3rem;">B.Com (Hons.), M.Com, UGC-NET JRF</h3>
   ...
   <!---- XXXX ---->
            ...
            <div class="card" style="height: 100%;width: 100%;border: 2px #fff solid;">
              <img
                src="images/management/deepika.jpg"
                class="card-img-top"
                alt="Waterfall" style="width: 100%;"
              />
              <div class="card-body">
                ...
                <p class="card-text text-center">
                 ...
                 <h3 class="tgfmlt text-center" style="color: #000; line-height: 1.5rem;font-size:1.3rem;">B.A.(Economics), M.A.(Economics), Ph.D., B.ED, PGDIBO</h3>
