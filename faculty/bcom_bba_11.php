    ...
    <section class="team">
        <div class="section-header"  id="fac">
          <h1 class="section-heading">Dept. of Management Studies</h1>
           <div class="underline"></div><h2>BBA & B.Com.(H)</h2>
        </div>
  <!-- Inner -->
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3">
            <div class="card" style="height: 80%;width: 100%;border: 1px #fff solid;">
              <img
                src="images/commerce/deepali.JPG"
                class="card-img-top"
                alt="Waterfall" style="width: 100%;" style="border-radius: 5px;"
              />
              <div class="card-body">
                <h5 class="card-title tgfmlt text-center" style="color: #000; line-height: 1.5rem;font-size:2rem;"><strong>Dr. Deepali Saluja</strong></h5>
                <p class="card-text">
                 <h3 class="tgfmlt text-center" style="color: #000; line-height: 1.5rem;font-size:1.3rem;">Head - BBA Programme</h3>
                 <h3 class="tgfmlt text-center" style="color: #000; line-height: 1.5rem;font-size:1.3rem;"></h3>
                 <h3 class="tgfmlt text-center" style="color: #000; line-height: 1.5rem;font-size:1.2rem;"></h3>
                </p>
               <!-- <a href="#!" class="btn btn-primary">Button</a> -->
              </div>
            </div>
